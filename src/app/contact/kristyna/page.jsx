       ...
       <div class="contact__container">
        ...
        <div class="contact__main-content">
          <div class="contact__btn">
            ...
            <Link href="/contact/paty" class="btn">Druhá autorka &raquo;</Link>
          </div>
          <div class="contact__header">
            <h1>Kristýna Konečná</h1>
            <div class="contact__social">
                <div class="footer__social-icons">
                    <Link href="mailto:kristyna.konecna@gmail.com" target="_blank" class="footer__icon">
                    <FontAwesomeIcon
                    className="footer__icon"
                    icon={faEnvelope}
                  /></Link>
                    <Link href="https://linkedin.com/in/kristýna-konečná-590292290" target="_blank" class="footer__icon">
                    <FontAwesomeIcon
                    className="footer__icon"
                    icon={faGithub}
                    /></Link>
                    <Link href="https://github.com/Kaykay-nova" target="_blank" class="footer__icon">
                    <FontAwesomeIcon
                    className="footer__icon"
                    icon={faLinkedin}
                    /></Link>
